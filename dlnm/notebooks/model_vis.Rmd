...
Based on this, I'm going to look at lags of 0 and 13.

```{r}
plot(crosspred('Qb2', b_mod, cen = 0),
     ptype = 'slices', lag = c(0, 13))
```
...
Yeah, we're basically predicting zero striped bass across the board. And the previously-noted lags of 0 and 13?
...
ggplot(data = new_data_lag, aes(x = Qb2, y = pred)) +
